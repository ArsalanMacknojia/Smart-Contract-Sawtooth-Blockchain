...
class NotaryTransactionHandler(TransactionHandler):
    ...
    def apply(self, transaction, context):
        ...
        The apply function does most of the work for this class by processing a transaction
        for the notary transaction family.
        """
        ...
        saledata = '{' + buyer_name + seller_name + house_id + '}'
        self._make_record_sale(context, saledata, from_key)

    @classmethod
    def _make_record_sale(cls, context, saledata, from_key):
        ...
        if not state_entries:
            ...
            new_sales = str(saledata) + str(sales)
        ...
        context.add_event(
            event_type="notary/Recordsale",
            attributes=[("sale-recorded", saledata)])
